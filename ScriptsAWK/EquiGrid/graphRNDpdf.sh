...
set style line 4 lc rgb '#000000' pt 3 ps 1 lt 1 lw 2 # --- black
...
plot '$FILE1' using 1:2 ti 'FLOOD' w lp ls 1 , \
        ...
        '$FILE21' using 1:2 ti 'BCIR*' w lp ls 3 , \
        '$FILE3' using 1:2 ti 'ABC' w lp ls 4
...
set terminal pdfcairo  enhanced font 'Verdana,14' linewidth 2
set output "${DIR}/transRNDgrid.pdf"
...
plot '$FILE4' using 1:2 ti 'FLOOD' w lp ls 1 , \
        ...
        '$FILE51' using 1:2 ti 'BCIR*' w lp ls 3 , \
        '$FILE6' using 1:2 ti 'ABC' w lp ls 4 
...
#set terminal postscript enhanced color solid eps 15
set terminal pdfcairo  enhanced font 'Verdana,14' linewidth 2
set output "${DIR}/transRNDini.pdf"
trans(x) = 18 + x
