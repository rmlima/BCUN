...
plot '$FILE1' using 1:2 ti 'FLOOD' w lp lt 1, "" using 1:2:3 notitle w errorbars lt 1, \
        '$FILE2' using 1:2 ti 'BCIR*' w lp lt 2, "" using 1:2:3 notitle w errorbars lt 2,\
        '$FILE3' using 1:2 ti 'ABC' w lp lt 3, "" using 1:2:3 notitle w errorbars lt 3
...
plot '$FILE4' using 1:2 ti 'FLOOD' w lp lt 1, "" using 1:2:3 notitle w errorbars lt 1, \
        '$FILE5' using 1:2 ti 'BCIR*' w lp lt 2, "" using 1:2:3 notitle w errorbars lt 2,\
        '$FILE6' using 1:2 ti 'ABC' w lp lt 3, "" using 1:2:3 notitle w errorbars lt 3
