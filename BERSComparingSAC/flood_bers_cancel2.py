...
display2.overhead(RMIN, RMAX, flood_avg_overhead, bers_avg_overhead, cancel2htarget_avg_overhead,
              bers2_avg_overhead, canceltarget_avg_overhead, NMAX)

display2.latency(RMIN, RMAX, flood_avg_latency, bers_avg_latency, bers2_avg_latency)
